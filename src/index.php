...
<body>
	...
	<!-- Start Home Section -->
	<section id="home" class="home-area animated-area hero-equal-height section-padding overflow-hidden d-flex align-items-center">
        <div id="particles-js">
			<!-- <img src="assets/img/banner-bg1.jpg" alt="partner-image"> -->
			<canvas class="particles-js-canvas-el" width="2474" height="1818" style="width: 100%; height: 100%;"></canvas>
		</div>
		<div class="container">
...
<!-- 						<div class="services-details-btn">
				...
				<div class="col-lg-4 col-md-6 col-sm-12">
					<div class="single-services-item">
						...
						<div class="services-info">
							<h6>DevOps</h6>
							<p>Integrate your development and operations teams throughout the application lifecycle to deliver continuous value and reduce the mean-time-to-repair (MTTR).</p>
						</div>
						<!-- <div class="services-details-btn">
							<a class="more-btn" href="#">Learn More</a>
						</div> -->
					...
					<div class="testimonial-slide">
						<div class="owl-carousel owl-theme">
							...
							<div class="single-testimonial">
								<div class="testimonial-content-inner">
									<div class="testimonial-text">
										<p>Partnered with 9Logic and migrated our entire solution from Rackspace to AWS. As a result of the migration to AWS we were able to meet the expectations of our clients and auditors as well as meet our expectations from the timeline and budget perspective. Improved the security and reduced the monthly spend by 20%</p>
							...
							<div class="single-testimonial">
								<div class="testimonial-content-inner">
									<div class="testimonial-text">
										<p>The results of 9Logic's Well-Architected Review (WAR) program were ranging from simple things like enabling Multi-Factor Authentication (MFA) and all the way up to more complicated things like using CloudFront to define the network resources and using AWS Fargate including Computing Scalability."</p>
										<div class="rating-box">
											<ul>
												<li><i class="fa fa-star"></i></li>
												<li><i class="fa fa-star"></i></li>
